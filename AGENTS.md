...
- The Obsidian vault lives under `memory/`.
- `memory/` is not Git-owned. Obsidian and OCI bucket sync own vault persistence.
...
- Canonical runtime config:
  - `OBSIDIAN_VAULT_PATH=/Users/ujwalgattupalli/Dev/evermind/memory`
